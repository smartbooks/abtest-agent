 ...
 * 推荐用户喜欢的物品列表
 */
public class RecommendItemAction extends ActionSupport {

    private final static Logger logger = LogManager.getLogger(RecommendItemAction.class);

    /**
     * ab分流实验所在的层
     */
    private final static String layoutName = "RECOMMEND_ITEM";
